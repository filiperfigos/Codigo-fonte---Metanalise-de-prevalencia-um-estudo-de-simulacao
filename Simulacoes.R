...
print(comparações) #Lista com as 7 matrizes com 1000 linhas cada
print(resultados1) #Medidas já prontas para análise
...
dados1 = subset(resultados1, ) #Dados que serão utilizados para o primeiro gráfico da figura
dados2 = subset(resultados1, ) #Dados que serão utilizados para o segundo gráfico da figura
dados3 = subset(resultados1, ) #Dados que serão utilizados para o terceiro gráfico da figura
dados4 = subset(resultados1, ) #Dados que serão utilizados para o quarto gráfico da figura
